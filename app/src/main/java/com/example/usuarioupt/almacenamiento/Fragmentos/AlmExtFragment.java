...
public class AlmExtFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        return
                inflater.inflate(R.layout.fragment_almext,container,false);
    ...
    public void guardarArchivo(String datos, Context context){
        ...
        if (!stadoSD.equals(Environment.MEDIA_MOUNTED)){
            Snackbar.make(getView(),"No es posible escribir"
                    + "en la memoria externa", Snackbar.LENGTH_SHORT).show();
            return;
        }
        try {
    ...
    public Vector<String> obtenerData(Context context){
        ...
        if (!stadoSD.equals(Environment.MEDIA_MOUNTED)
            ...
            Toast.makeText(context, "No se puede" + "leer la memoria externar",Toast.LENGTH_SHORT).show();
            return result;
        }try {
            verifyStoragePermissions(getActivity());
